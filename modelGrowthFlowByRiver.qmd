...
<!-- gamS10ByArea <- bam(grWeight ~ (riverGG + seasonGG + observedWeight + tempS + flowByAreaS +  -->
<!--                                propBelowLoFlowThreshByArea_flowExt + propAboveHiFlowThreshByArea_flowExt)^2 + cohortF +              -->
<!--                s(meanFlow, bs = "cr", k = kIn, by = riverGG) + -->
<!--                #s(flowByAreaS, bs = "cr", k = kIn, by = seasonGG) + -->
<!--                s(meanTemperature, bs = "cr", k = kIn, by = riverGG), -->
<!--                #s(tempS, bs = "cr", k = kIn, by = seasonGG), -->
<!--              data = dGAM |> filter(speciesGG == speciesIn, cohort %in% 2000:2013), method = "REML") -->

<!-- AIC(gamS1ByArea, gamS2ByArea, gamS3ByArea, gamS4ByArea,  -->
<!--     gamS5ByArea, gamS6ByArea, gamS7ByArea, gamS10ByArea) |> arrange(AIC) -->
...
<!-- #take out significant smooths -->
<!-- gamS8ByRiver <- bam(grWeight ~ (riverGG + seasonGG + observedWeight + tempS + flowByRiverS +  -->
<!--                                 propBelowLoFlowThreshByRiver + propAboveHiFlowThreshByRiver)^2 + cohortF +              -->
<!--                s(flowByRiverS, bs = "cr", k = kIn, by = riverGG) , -->
<!--              data = dGAM |> filter(speciesGG == speciesIn, cohort %in% 2000:2013), method = "REML") -->

<!-- #take out insignificant smooths -->
<!-- gamS9ByRiver <- bam(grWeight ~ (riverGG + seasonGG + observedWeight + tempS + flowByRiverS +  -->
<!--                                 propBelowLoFlowThreshByRiver + propAboveHiFlowThreshByRiver)^2 + cohortF +              -->
<!--                s(flowByRiverS, bs = "cr", k = kIn, by = seasonGG) + -->
<!--                s(tempS, bs = "cr", k = kIn, by = riverGG) + -->
<!--                s(tempS, bs = "cr", k = kIn, by = seasonGG), -->
...
<!-- gamS10ByRiver <- bam(grWeight ~ (riverGG + seasonGG + observedWeight + tempS + flowByRiverS +  -->
<!--                                 propBelowLoFlowThreshByRiver + propAboveHiFlowThreshByRiver)^2 + cohortF +              -->
<!--                s(meanFlow, bs = "cr", k = kIn, by = riverGG) + -->
<!--                #s(flowByRiverS, bs = "cr", k = kIn, by = seasonGG) + -->
<!--                s(meanTemperature, bs = "cr", k = kIn, by = riverGG),  -->
...
<!--     gamS5ByRiver, gamS6ByRiver, gamS7ByRiver, gamS8ByRiver, gamS9ByRiver, gamS10ByRiver) |> arrange(AIC) -->
<!-- ``` -->


<!-- #### Brook trout - compare flow byArea and flow byRiver gams -->
<!-- ```{r} -->
...
<!-- gamS6BKTPredictions <- predictBKTgamS(dGAM, gamS6ByRiver, gamS6ByArea) -->

<!-- predict10BKTgamS <- function(dIn, modInFlowByRiver, modInFlowByArea){ -->

<!--   predMatByRiver0 <-  -->
<!--     expand.grid( -->
<!--       meanFlow = seq(0, 0.8, 0.2),  -->
<!--       propBelowLoFlowThreshByRiver = seq(0, 0.8, 0.2), -->
<!--       propAboveHiFlowThreshByRiver = seq(0, 0.6, 0.2), -->
...
<!-- gamS10BKTPredictions <- predict10BKTgamS(dGAM, gamS10ByRiver, gamS10ByArea) -->
<!-- ``` -->
...
<!-- predictBKTgamS <- function(dIn, modInFlowByArea, modInFlowByRiver){ -->
...
<!-- gamSBKTPredictions <- predictBKTgamS(dGAM, gamS1ByArea, gamS1ByRiver) -->
<!-- ``` -->
...
#### West brook
```{r}
#| label: graphGAMPredictionsByRiverSmallFishTalkTWB
...
#### Open Large
```{r}
#| label: graphGAMPredictionsByRiverSmallFishTalkTOL
...
#### Open Small
```{r}
#| label: graphGAMPredictionsByRiverSmallFishTalkTOS
...
#### Isolated Small
```{r}
#| label: graphGAMPredictionsByRiverSmallFishTalkTIS
...
### Flow std by season/river (not used)
