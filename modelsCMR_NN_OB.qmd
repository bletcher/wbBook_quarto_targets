...
Black dots/line is estimated probability of mortality and orange dots are encountered yes/no. The green line is the first observation and the red line is the last observation. The number in the upper right corner of each panel is the fish's cohort. 
```{ojs}
Plot.plot({
  width: width,
  height: 350,
