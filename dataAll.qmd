...
allGT1500 <- all %>%
  ...
  dplyr::select(tag, detectionDate, riverMeter, section, survey)
...
tagsOverTime = Plot.plot({
  marks: [
    ...
    Plot.dot(tagsToPlot, { x: "detectionDate", y: "riverMeter", stroke: "tag", symbol: "survey" }),
    Plot.line(tagsToPlot, { x: "detectionDate", y: "riverMeter", stroke: "tag" })
  ],
  facet: {
