...
__sampleNumber__ An identifier for the consecturitve sample number for each river.  
...
__riverTagged__ The river in whcih the fish was tagged.  
...
__yearOfStocking__ Year of stocking when stocking occured.  
...
__predMass__ Whether mass was prdicted from length ("Yes") or measured ("No").  
...
__effort__ Electrofishing effort in seconds.  
