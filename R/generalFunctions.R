theme_publication <- function (base_size = 14, base_family = "", legendPosition = "bottom", legendDirection = "horizontal") {
  library(grid)
  library(ggthemes)
  ...
  theme(
    ...
    axis.text = element_text(), axis.line = element_line(colour = "#303030"), 
    ...
    legend.position = legendPosition, legend.direction = legendDirection, 
    legend.key.size = unit(0.2, "cm"), legend.title = element_text(face = "italic"), 
    plot.margin = unit(c(10, 5, 5, 5), "mm"), 
    strip.background = element_rect(colour = "#f0f0f0", fill = "#f0f0f0"), 
    strip.text = element_text(face = "bold"), 
    panel.border = element_rect(colour = "#303030")
  )
}
