...
Original run using hyper_grid_W0
    eta max_depth min_child_weight subsample colsample_bytree optimal_trees    min_RMSE
1  0.01         7                5      0.65              0.8          1376 0.001847600
2  0.05         7                3      0.80              0.9           292 0.001848465
3  0.01         7                7      0.80              0.9          1382 0.001849086
4  0.01         5                1      0.80              0.8          2399 0.001849250
5  0.05         7                3      0.80              0.8           281 0.001849258
6  0.01         5                3      0.65              0.8          2147 0.001849905
7  0.05         5                1      0.65              0.8           459 0.001849931
8  0.01         5                5      0.80              0.9          2296 0.001850049
9  0.01         7                5      0.65              0.9          1402 0.001850246
10 0.01         7                7      0.65              0.8          1382 0.001850544
11 0.01         7                3      0.65              0.8          1384 0.001850704
12 0.05         3                3      0.80              0.8          1509 0.001850763
13 0.01         7                7      0.80              0.8          1453 0.001850975
14 0.01         7                1      0.80              1.0          1281 0.001851069
15 0.01         7                1      0.80              0.8          1473 0.001851078


####  Fit the top model
```{r}
#| label: fitContinuous_W

xgb.fit.final_W <- tar_read(xgb.fit.final_W_target)
...
# variable importance plot
xgb.plot.importance(importance_matrix_W, top_n = 10, measure = "Gain")
...
gridExtra::grid.arrange(pW_W,pFlow_W, pTemp_W, pAge_W, pCohort_W, nrow = 3)
```
#### Lime
```{r}
...
caret::RMSE(pred_W, response_test_W)
caret::R2(pred_W, response_test_W)
```
