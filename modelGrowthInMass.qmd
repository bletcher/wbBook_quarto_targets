...
xgb.plot.importance(xgb.importance(model = propNegBKT$xgb), top_n = 10, measure = "Gain")
...
# variable importance plot
xgb.plot.importance(xgb.importance(model = propNegBNT$xgb), top_n = 10, measure = "Gain")
...
# variable importance plot
xgb.plot.importance(xgb.importance(model = propNegATS$xgb), top_n = 10, measure = "Gain")
