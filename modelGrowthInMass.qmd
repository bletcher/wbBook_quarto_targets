...
ggplot(negGr_seenNotSeenYearAgeCD_wideMeans |> filter(seasonGG == "Summer", riverGG == "West Brook"), aes(gainedLost, meanRatio)) +
  geom_col(position = "dodge") +
  geom_errorbar(aes(ymin = ymin, ymax = ymax), position = position_dodge(0.9), width = 0.2) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  labs(y = "Ratio of fish not seen again to fish seen again", x = "Growth in mass") +
...
ggplot(negGr_seenNotSeenYearAgeCD_wideMeans |> filter(seasonGG %in% c("Summer","Autumn"), riverGG == "West Brook"), aes(gainedLost, meanRatio, fill = factor(age), color = factor(age))) +
  geom_col(position = "dodge") +
  geom_errorbar(aes(ymin = ymin, ymax = ymax), position = position_dodge(0.9), width = 0.2) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  #labs(y = "Ratio of fish not seen again to fish seen again", x = "Growth in mass") +
