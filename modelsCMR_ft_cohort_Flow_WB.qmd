...
THis is a 'fork' of **modelsCMR_ft_cohort_Flow_OB.qmd** where the models were originally worked out. following Daniel's march 2023 changes, Ben adapted the ..._OB file to this ..._4Rivers file. 
...
Model is run using targets in R/modelCMR_ttt_ft_cohort_WB.R
```{r}
#| label: wb_ttt_flow
# Following https://oliviergimenez.github.io/bayesian-cr-workshop/worksheets/4_demo.html
# 
  out_flow <- tar_read(tt_modelOut_ft_cohort_WB_flow)
